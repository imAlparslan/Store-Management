...
public class ProductGroupRepositoryTests : IClassFixture<ProductGroupRepositoryFixture>
{
    ...
    public ProductGroupRepositoryTests(ProductGroupRepositoryFixture productGroupRepositoryFixture)
    {
        ...
        _unitOfWorkManager = productGroupRepositoryFixture._unitOfWorkManager;
    }

    [Fact]
    public async void Find_By_Id_Should_Return_Correct_ProductGroup()
    {
    ...
    [Fact]
    public async void Insert_Product_Should_Return_Inserted_ProductGroup()
    {
        var productGroup = ProductGroupFactory.CreateRandom();
    ...
    [Fact]
    public async void Update_ProductGroup_Name_Should_Return_ProductGroup_With_New_Name()
    {
        var productGroup = ProductGroupFactory.CreateRandom();
    ...
    [Fact]
    public async void Update_ProductGroup_Definition_Should_Return_ProductGroup_With_New_Definition()
    {
        var productGroup = ProductGroupFactory.CreateRandom();
